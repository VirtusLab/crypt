...
[![Version](https://img.shields.io/badge/version-v0.3.0-brightgreen.svg)](https://github.com/VirtusLab/crypt/releases/tag/v0.3.0)
...
- [Mac OS 64 bit](https://github.com/VirtusLab/crypt/releases/download/v0.3.0/crypt-darwin-amd64)
- [Linux 64 bit](https://github.com/VirtusLab/crypt/releases/download/v0.3.0/crypt-linux-amd64)
- [Windows 64 bit](https://github.com/VirtusLab/crypt/releases/download/v0.3.0/crypt-windows-amd64)
